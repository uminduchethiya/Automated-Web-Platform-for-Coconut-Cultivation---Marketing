...
<body>
   ...
   <form action="" method="post" class="box">
      ...
      <input type="submit" value="Buy now" class=" btn btn-sm btn-light dropdown-toggle" name="buy">
      <input type="submit" value="Add to cart" class="btn btn-sm btn-light dropdown-toggle" name="add_to_cart">
